...
if success:
    ...
    if args.requested_mock_data:
        ...
        user1 = User(first_name='Jadon', last_name='Fan', email='j53fan@uwaterloo.ca',
                     firebase_token=uuid.uuid4(), is_admin=True)
        user2 = User(first_name='Chandler', last_name='Lei', email='q4lei@uwaterloo.ca',
                     firebase_token=uuid.uuid4(), is_admin=True)
        ...
        feedback1 = Feedback(type=Feedback.Type.SENTIMENT, text='testing...',
                             score=2.5, time_range=NumericRange(1, 10),
                             user_report='is this working?', upload_id=upload1.id)
